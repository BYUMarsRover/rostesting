...
void Pololu::send(uint16_t q1, uint16_t q2, uint16_t q3, uint16_t q4, uint16_t q5, uint16_t q6, uint16_t grip)
{
  uint8_t array[16];
  array[0] = 0xEA;
  array[1] = 0xE3;
  ...
  array[13] = (q6>>8)&0xff;
  array[14] = grip&0xff;
  array[15] = (grip>>8)&0xff;

  link->send_bytes(array,16);
}
...
{
  this->send(command_msg.q1,command_msg.q2,command_msg.q3,command_msg.q4,command_msg.q5,command_msg.q6,command_msg.grip);
}
