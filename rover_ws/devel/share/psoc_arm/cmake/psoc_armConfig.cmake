...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'psoc_arm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/halrover/git/rostesting/rover_ws/src/psoc_arm/${idir}'.  Ask the maintainer 'Gary Ellingson <gary.ellingson@byu.edu>' to fix it.")
    endif()
